...
```
git clone https://github.com/KnowHowSpringBoot/quickstart-kafka-consuming-hello.git

cd quickstart-kafka-consuming-hello
```
...
- Run **quickstart-kafka-consuming-hello** app:
